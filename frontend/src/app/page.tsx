...
const roofingServices = [
  ...
  { title: 'Metal Roofing', description: 'Standing seam and metal roofing built for Florida. Wind resistance to 140+ mph and a 40-70 year lifespan.', href: '/services/metal-roofing', image: '/images/green-metal-roof-residential.webp', alt: 'Metal Roofing in Jacksonville FL', imgTitle: 'Metal Roofing in Jacksonville FL' },
  { title: 'Gutters', description: 'Seamless gutter installation, repair, and replacement to protect your roof and foundation from heavy rain.', href: '/services/roof-gutter', image: '/images/completed-roof-project-jacksonville.webp', alt: 'Gutter installation and repair in Jacksonville FL', imgTitle: 'Gutter Installation and Repair in Jacksonville FL' },
  { title: 'Roof Waterproofing', description: 'Roof coatings and waterproofing that seal leaks and extend the life of flat and low-slope roofs.', href: '/services/roof-waterproofing', image: '/images/roof-leak-emergency-repair.webp', alt: 'Roof waterproofing in Jacksonville FL', imgTitle: 'Roof Waterproofing in Jacksonville FL' }
]
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-center">
            ...
            <div className="lg:col-span-3 space-y-5 text-gray-700 leading-relaxed text-base">
              <p>
                Founded in 2001, Gimo&apos;s Roofing has been serving Jacksonville and Northeast Florida for over 25 years. What started as a small family operation has grown into one of the area&apos;s most requested roofing contractors, with over 500 completed roofs and a 5-star rating across Google, Yelp, and Thumbtack. Every project we take on is led by an experienced crew, overseen by our founder, and backed by the manufacturer warranties our homeowners count on for decades.
              </p>
              <p>
              ...
              <p>
                Whether you need a full <Link href="/services/roof-replacement" className="text-primary hover:underline">roof replacement</Link>, a quick <Link href="/services/roof-repair" className="text-primary hover:underline">roof repair in Jacksonville</Link>, or 24/7 <Link href="/services/emergency-roof-repair" className="text-primary hover:underline">emergency roof repair</Link> after a storm, we show up on time, communicate clearly, and leave the jobsite cleaner than we found it. That&apos;s why so many Jacksonville homeowners refer us to their neighbors.
              </p>
            </div>
          </div>
        </div>
