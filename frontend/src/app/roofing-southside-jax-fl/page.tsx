...
const faqs = [
  { question: `How much does roof replacement cost in ${location}?`, answer: `Roof replacement in ${location} ranges from $7,500 to $30,000+ depending on size and materials. Commercial properties vary based on building size. We provide free estimates.` },
  { question: `Do you handle both residential and commercial roofing?`, answer: `Yes! We serve both residential homes and commercial properties throughout Southside Jacksonville, from the Town Center area to Baymeadows.` },
  { question: `What roofing materials are best for ${location}?`, answer: `For residential, architectural shingles or metal roofing are popular. For commercial buildings, we recommend TPO, EPDM, or metal roofing systems.` },
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          ...
          "description": "Quality residential roofing for Southside Jacksonville homes from Town Center to Baymeadows."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Professional commercial roofing services for Southside Jacksonville businesses."
        }
      }
    ]
  }
      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-gray-600 mb-4">
            {location} is one of Jacksonville&apos;s most dynamic areas, home to the St. Johns Town Center, major employers, and diverse residential neighborhoods. From condos to single-family homes to commercial properties, the Southside has a wide range of roofing needs.
          </p>
          <p className="text-gray-600">
            At Gimo&apos;s Roofing, we serve the entire Southside area—from Baymeadows to Deerwood to the Town Center—with professional roofing services for both residential and commercial properties.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: "Residential Roofing", desc: "Replacement and repair for homes of all sizes." },
              { title: "Commercial Roofing", desc: "TPO, EPDM, metal for businesses." },
              { title: "Storm Damage", desc: "24/7 emergency response and insurance help." },
              { title: "Architectural Shingles", desc: "Premium shingles for residential homes." },
              { title: "Metal Roofing", desc: "Long-lasting systems for homes and businesses." },
