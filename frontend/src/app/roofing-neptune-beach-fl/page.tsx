    ...
    <>
      ...
      <section className="relative overflow-hidden bg-secondary">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <HeroQuoteForm location="Neptune Beach" />
          </div>
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <h3 className="text-2xl font-bold text-secondary mb-4">Top-Rated Roofing in Neptune Beach, FL</h3>
              <p className="text-gray-600 mb-4">
                Gimo&apos;s Roofing serves homeowners and businesses across Neptune Beach and the surrounding coastal communities. From <Link href="/services/roof-replacement" className="text-primary hover:underline">roof replacement</Link> and <Link href="/services/roof-repair" className="text-primary hover:underline">roof repair in Neptune Beach</Link> to <Link href="/services/emergency-roof-repair" className="text-primary hover:underline">emergency roof repair</Link>, <Link href="/services/metal-roofing" className="text-primary hover:underline">metal roofing</Link>, and <Link href="/services/roof-gutter" className="text-primary hover:underline">gutter installation</Link>, our crews are the same local team on every job, not subcontractors.
              </p>
              <p className="text-gray-600 mb-6">
                Proudly serving Neptune Beach and all of Northeast Florida&apos;s coastal communities. Call Gimo&apos;s Roofing at <a href={`tel:+1${phone.replace(/\D/g, '')}`} className="text-primary font-semibold hover:underline">{phone}</a> for a free estimate!
              </p>
