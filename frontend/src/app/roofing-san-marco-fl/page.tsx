    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Gimo&apos;s Roofing is based in Jacksonville and serves homeowners throughout San Marco, San Jose, and St. Nicholas. From <Link href="/services/roof-repair" className="text-primary hover:underline">tile roof repair in San Marco, FL</Link> and full <Link href="/services/roof-replacement" className="text-primary hover:underline">roof replacement</Link> to <Link href="/services/emergency-roof-repair" className="text-primary hover:underline">emergency roof repair</Link>, <Link href="/services/metal-roofing" className="text-primary hover:underline">metal roofing</Link>, and <Link href="/services/roof-gutter" className="text-primary hover:underline">gutter installation</Link>, our crews are the same local team on every job, not subcontractors.
              </p>
              <p className="text-gray-600 mb-6">
                Proudly serving San Marco, San Jose, St. Nicholas, and all of Jacksonville&apos;s historic neighborhoods. Call Gimo&apos;s Roofing at <a href={`tel:+1${phone.replace(/\D/g, '')}`} className="text-primary font-semibold hover:underline">{phone}</a> for a free estimate!
              </p>
      ...
      <section className="relative overflow-hidden bg-secondary py-16">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-gray-300 mb-6">Contact us today for expert Mediterranean and tile roofing services in {location}.</p>
