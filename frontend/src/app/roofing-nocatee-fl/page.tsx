    ...
    <>
      ...
      <section className="relative overflow-hidden bg-secondary">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <HeroQuoteForm location="Nocatee" />
          </div>
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <h3 className="text-2xl font-bold text-secondary mb-4">Top-Rated Roofing in Nocatee, FL</h3>
              <p className="text-gray-600 mb-4">
                Gimo&apos;s Roofing serves homeowners throughout Nocatee&apos;s master-planned communities in St. Johns County. From <Link href="/services/roof-repair" className="text-primary hover:underline">roof repair in Nocatee, FL</Link> and full <Link href="/services/roof-replacement" className="text-primary hover:underline">roof replacement</Link> to <Link href="/services/emergency-roof-repair" className="text-primary hover:underline">emergency roof repair</Link>, <Link href="/services/metal-roofing" className="text-primary hover:underline">metal roofing</Link>, and <Link href="/services/roof-gutter" className="text-primary hover:underline">gutter installation</Link>, our crews are the same local team on every job, not subcontractors.
              </p>
              <p className="text-gray-600 mb-6">
                Proudly serving {location}, Town Center, and all surrounding {county} communities. Call Gimo&apos;s Roofing at <a href={`tel:+1${phone.replace(/\D/g, '')}`} className="text-primary font-semibold hover:underline">{phone}</a> for a free estimate!
              </p>
      ...
      <section className="relative overflow-hidden bg-secondary py-16">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-gray-300 mb-6">Contact us today for expert roofing services in {location} and all of {county}.</p>
