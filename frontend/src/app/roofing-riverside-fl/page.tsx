...
export const metadata: Metadata = {
  title: { absolute: "Roofing Riverside Jacksonville FL - Gimo's Roofing" },
  description: "Roofing contractors Riverside Jacksonville FL. Historic bungalow and craftsman home roofing specialists. Roof repair, replacement, and storm response. Call (904) 606-5313.",
  openGraph: {
    title: "Roofing Riverside Jacksonville FL - Gimo's Roofing",
    description: "Roofing contractors Riverside Jacksonville FL. Historic home specialists. Call (904) 606-5313.",
...
const faqs = [
  ...
  { question: "What original wood plank decking should I expect on a Riverside re-roof?", answer: "Almost every home in Riverside built before 1955 has original 1x6 or 1x8 tongue-and-groove pine plank decking rather than modern plywood, and that decking is one of the most important things to handle correctly during a re-roof. The good plank is often still structurally sound after 90+ years and we leave it alone. The problem boards are the ones near valleys, around chimneys, and under previously-leaking flashings, where decades of moisture have rotted the wood. Florida code requires us to replace any rotted decking we find, and on a typical Riverside bungalow we will swap out 4-12 boards for $35-65 each depending on access. Some roofers cover rotted decking with new plywood overlay. We do not do that because it traps moisture and shortens the life of everything above it." },
  { question: "What are the most common Certificate of Appropriateness violations for roofing in Riverside?", answer: "The three violations we see most often are wrong shingle profile (using a smooth flat-look shingle instead of a dimensional or shake-style product), wrong color (going lighter than the JHPC palette allows for the period of the home), and unauthorized material changes (switching from metal to shingle or vice versa without board approval). The JHPC in Jacksonville takes the Riverside-Avondale Historic District seriously, and a violation can result in a stop-work order, fines, and a requirement to tear off the non-compliant roof and start over. We have seen this happen to homeowners who hired out-of-area roofers unfamiliar with Riverside's rules. We pre-screen every material and color choice against the JHPC guidelines before we order anything." },
...
const breadcrumbSchema = {
  "@context": "https://schema.org",
  "@id": "https://www.gimosroofing.com/roofing-riverside-fl#breadcrumb",
  "@type": "BreadcrumbList",
  "itemListElement": [
...
export default function RiversidePage() {
  return (
    <>
      ...
      {/* Local Elements: Map + Service Area (moved right after hero/stats per client direction, matching the Jacksonville reference pattern) */}
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <h3 className="text-2xl font-bold text-secondary mb-4">Top-Rated Roofing in {location}, FL</h3>
              <p className="text-gray-600 mb-4">
                Gimo&apos;s Roofing is based in Jacksonville and serves homeowners throughout Riverside, Avondale, and Five Points. From <Link href="/services/roof-repair" className="text-primary hover:underline">roof repair in Riverside, FL</Link> and full <Link href="/services/roof-replacement" className="text-primary hover:underline">roof replacement</Link> to <Link href="/services/emergency-roof-repair" className="text-primary hover:underline">emergency roof repair</Link>, <Link href="/services/metal-roofing" className="text-primary hover:underline">metal roofing</Link>, and <Link href="/services/roof-gutter" className="text-primary hover:underline">gutter installation</Link>, our crews are the same local team on every job, not subcontractors.
              </p>
              <p className="text-gray-600 mb-6">
                Proudly serving Riverside, Avondale, Five Points, and all of Jacksonville&apos;s historic neighborhoods. Call Gimo&apos;s Roofing at <a href={`tel:+1${phone.replace(/\D/g, '')}`} className="text-primary font-semibold hover:underline">{phone}</a> for a free estimate!
              </p>
      ...
      <section className="relative overflow-hidden bg-secondary py-16">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-gray-300 mb-6">Contact us today for expert historic home roofing services in {location}.</p>
