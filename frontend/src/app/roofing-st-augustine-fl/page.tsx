    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          ...
          "description": "Expert tile and slate roofing for St. Augustine's historic district homes."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          "@type": "Service",
          "name": "Roof Replacement in St. Augustine FL",
          "description": "Quality roof replacement preserving St. Augustine's architectural heritage."
        }
      }
    ]
  }
