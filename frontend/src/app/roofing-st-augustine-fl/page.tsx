    ...
    <>
      ...
      <section className="py-14">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <h3 className="text-2xl font-bold text-secondary mb-4">Top-Rated Roofing in St. Augustine, FL</h3>
              <p className="text-gray-600 mb-4">
                Gimo&apos;s Roofing serves homeowners across St. Augustine, from the Historic District and Anastasia Island to Palencia and World Golf Village. From <Link href="/services/roof-replacement" className="text-primary hover:underline">roof replacement</Link> and <Link href="/services/roof-repair" className="text-primary hover:underline">roof repair in St. Augustine, FL</Link> to <Link href="/services/emergency-roof-repair" className="text-primary hover:underline">emergency roof repair</Link>, <Link href="/services/metal-roofing" className="text-primary hover:underline">metal roofing</Link>, and <Link href="/services/roof-gutter" className="text-primary hover:underline">gutter installation</Link>, our crews are the same local team on every job, not subcontractors.
              </p>
              <p className="text-gray-600 mb-6">
                Proudly serving {location} and all of {county} from the Historic District to World Golf Village. Call Gimo&apos;s Roofing at <a href={`tel:+1${phone.replace(/\D/g, '')}`} className="text-primary font-semibold hover:underline">{phone}</a> for a free estimate!
              </p>
      ...
      <section className="relative overflow-hidden bg-secondary py-16">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-gray-300 mb-6">Contact us today for expert roofing services in {location} and {county}.</p>
