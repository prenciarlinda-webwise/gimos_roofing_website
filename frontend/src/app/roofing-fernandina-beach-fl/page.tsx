...
const faqs = [
  ...
  { question: "What areas of Fernandina Beach and Nassau County do you serve?", answer: "We serve all of Amelia Island and the surrounding Nassau County mainland. On the island, that includes the Fernandina Beach historic downtown, Amelia Island Plantation, Summer Beach, the South Fletcher Avenue oceanfront stretch, Sadler Road and Bailey Road residential, the American Beach historic community, Old Town, and the Fort Clinch / Atlantic Avenue area at the northern end. ZIP codes 32034 (most of the island and city) and 32035 (P.O. boxes and some adjacent). On the mainland, we serve Yulee, O'Neil, the Nassauville stretches, and the Crawford Diamond and Dyal areas. Same-week scheduling for inspections and free estimates throughout Nassau County. Call (904) 606-5313 or request a quote online." },
