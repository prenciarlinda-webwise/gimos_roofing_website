...
const faqs = [
  { question: `How much does roof replacement cost in ${location}?`, answer: `Roof replacement in ${location} typically ranges from $7,500 to $25,000 depending on size and materials. We offer free estimates and financing options.` },
  { question: `What roofing materials work best in ${location}?`, answer: `Architectural shingles are the most popular choice in ${location}. We also install metal roofing for homeowners wanting longer-lasting options.` },
  { question: `Do you offer financing for ${location} homeowners?`, answer: `Yes! We offer flexible financing options with payments as low as $99/month to make your roofing project affordable.` },
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "Roof Replacement in Orange Park FL",
          "description": "Quality roof replacement services for Orange Park and Clay County families."
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          ...
          "description": "Fast, reliable roof repair services for Orange Park homeowners."
        }
      }
    ]
  }
      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-gray-600 mb-4">
            {location} is a thriving community in Clay County, known for its family-friendly neighborhoods and excellent schools. Homes here need reliable roofing that can withstand Florida&apos;s weather while providing lasting value.
          </p>
          <p className="text-gray-600">
            At Gimo&apos;s Roofing, we&apos;ve been serving {location} homeowners with honest service, quality materials, and expert installation. Whether you need a small repair or complete roof replacement, we&apos;re here to help.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: "Roof Replacement", desc: "Complete replacement with quality materials. Starting at $7,500." },
              { title: "Roof Repair", desc: "Fast, reliable repairs for leaks and damage." },
              { title: "Storm Damage", desc: "24/7 emergency response and insurance assistance." },
              { title: "Shingle Roofing", desc: "Architectural shingles in many colors." },
              { title: "Metal Roofing", desc: "Long-lasting metal roof systems." },
              { title: "Roof Inspections", desc: "Free inspections and estimates." }
            ].map((service) => (
