...
const faqs = [
  ...
  { question: "Do you offer financing for Orange Park homeowners?", answer: "Yes — financing is the right call for most Clay County families and we make it easy. Our standard plans start at $99/month for smaller architectural shingle replacements (typically 1,500-1,800 sq ft homes in Lakeside or the older Argyle stretches), with longer terms and larger amounts available for the bigger homes in Eagle Harbor and Oakleaf. Approval is usually instant or same-day through our financing partners, and we run a soft credit check that doesn't affect your score. Most plans have no prepayment penalty, so if your insurance claim comes through later or your tax refund hits, you can pay it off early. We also accept all major credit cards. Talk to us about what works for your budget — there's almost always a way to get the roof done now and pay over time." },
  { question: "What roofing material gives Orange Park homeowners the best long-term value?", answer: "For most Orange Park homes, a 30-year architectural shingle (GAF Timberline HDZ or CertainTeed Landmark) is the best value play. You're getting 22-28 years of real-world life in Clay County's climate, hurricane-rated wind ratings, multiple color options, and the lowest cost-per-year of any common material. We install this on probably 80% of our Orange Park projects. For homeowners planning to stay in the home 25+ years, standing seam metal in galvalume costs roughly 60-80% more upfront but lasts 50+ years and qualifies for additional insurance premium credits — the math works out cheaper per year if you keep the home. We don't recommend 3-tab shingles to anyone in Clay County anymore: the 12-15 year lifespan and weak wind rating make them a false economy. We bring physical samples of every option to the estimate." },
  { question: "Do you serve Fleming Island, Green Cove Springs, and the rest of Clay County?", answer: "Yes — we cover all of Clay County and the immediate surrounding mainland. That includes Orange Park (32065, 32073), Fleming Island and Eagle Harbor (32003), Lakeside, Bellair, Loch Rane, the Argyle Forest and Oakleaf Plantation stretches off Blanding (32068, 32222), Middleburg, Green Cove Springs (32043), Doctors Inlet, Penney Farms, and the Black Creek areas. Same-week scheduling for free inspections and estimates anywhere in the county. We know the different home styles and HOA requirements across the various Clay County communities — the Eagle Harbor and Oakleaf ARBs, in particular, have specific approved materials and color matrices that we maintain current samples for. Call (904) 606-5313 or request a quote online and we'll come out same week." },
