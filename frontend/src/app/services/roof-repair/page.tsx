          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-200 mb-6">
                Searching for roof repair near me in Jacksonville? Gimo&apos;s Roofing, a <Link href="/roofing-jacksonville-fl" className="text-primary font-semibold hover:underline">roofing company in Jacksonville FL</Link> homeowners have trusted since 2001, fixes roof leaks, damaged shingles, failed flashing, and flat roof repair across Duval, St. Johns, Clay, and Nassau counties. Our roof leak repair services cover everything from a slow drip to emergency roof leak repair after a storm, and same-day response is available for roof repair Jacksonville FL homeowners need fast, with most repairs completed in one visit using materials we stock on our trucks.
              </p>
            ...
            <div className="card p-8">
              <div className="grid md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-600 mb-4">Whether you&apos;d call it leaky roof repair, leaking roof repair, or just a roof leak fix, it&apos;s the same job to us: find where the water is actually getting in, not just where it shows up on the ceiling. As a roof leak repair company that also handles the shingle, flashing, or decking work a leak usually exposes, you&apos;re not stuck coordinating between a leak repair near me search and a separate contractor for the fix.</p>
