...
const faqs = [
  ...
  { question: "What are the disadvantages of roof waterproofing?", answer: "Waterproofing is not a cure-all. A coating extends the life of a sound roof but will not fix a structurally failing or badly rotted roof, it has to be reapplied every 10 to 20 years depending on the product, and it must be applied to a clean, dry, properly prepped surface or it can peel. On a roof near the end of its life, replacement is the better value, and we will tell you honestly which one your roof needs." },
  { question: "Which type of roof waterproofing is best?", answer: "It depends on the roof. Silicone coatings handle ponding water and intense Florida UV well and are popular on flat and low-slope roofs. Acrylic and elastomeric coatings are reflective and cost-effective on sloped and metal roofs. Peel-and-stick membranes and flashing sealant protect seams, valleys, and penetrations. We match the system to your roof type and the problem we are solving rather than using one product for everything." },
  { question: "Can you waterproof a concrete or flat roof?", answer: "Yes. Flat and concrete roofs are some of the best candidates for waterproofing because they hold water longer than sloped roofs. We clean and prime the surface, seal cracks and joints, and apply a silicone or elastomeric membrane that creates a seamless waterproof layer. This is common on the flat and low-slope commercial roofs around downtown Jacksonville and the Southside." }
]
  ...
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">There is no single best waterproofing product. If you searched for roof coating near me, the specific product matters more than the search term. We match the method to your roof type, slope, and the source of the problem as your roof coating contractor, not a one-size product sold the same way to every roof. Most Jacksonville projects combine two or three of the systems below.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">Waterproofing is one of the highest-value steps you can take on a sound roof. It protects the structure, lowers cooling costs, and buys years of additional service life. Professional roof waterproofing services do more than DIY sealant in a caulk tube, correct surface prep and the right product for your roof type are what make the difference last.</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-600 text-sm mt-3">Coating a failing roof only traps moisture. We will tell you honestly when replacement is the better value. Explore our <Link href="/services/roof-replacement" className="text-primary hover:underline">roof replacement service in Jacksonville, FL</Link> for full tear-off and installation options.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-secondary mb-3">Roof Waterproofing Resources</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Learn more about coating options and how waterproofing compares to full replacement.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/blog/roof-coating-options-florida" className="card p-6 group">
              ...
              <p className="text-gray-600 text-sm">Elastomeric, acrylic, and silicone coatings compared for extending roof life.</p>
            </Link>
            <Link href="/blog/roof-waterproofing-vs-replacement-florida" className="card p-6 group">
              <h3 className="font-bold text-secondary mb-2 group-hover:text-primary transition-colors">Waterproofing vs Replacement</h3>
              <p className="text-gray-600 text-sm">Which one your Florida roof actually needs, and how to tell the difference.</p>
            </Link>
