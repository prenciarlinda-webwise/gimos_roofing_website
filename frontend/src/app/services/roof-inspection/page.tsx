        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600">Every inspection includes photo documentation, so whether you need it for your own records, an insurance adjuster, or a real estate closing, you walk away with something concrete, not just a verbal opinion.</p>
            </div>
