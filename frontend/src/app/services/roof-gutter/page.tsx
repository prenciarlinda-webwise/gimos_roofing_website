        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600">We can add guards to a new gutter installation or fit them to existing gutters that are still in good shape. If your gutters are already failing, guards on a bad system are not worth it, and we will say so. See our full <Link href="/blog/gutter-systems-roofing-florida" className="text-primary hover:underline">gutter cleaning and repair near me</Link> guide for the full maintenance schedule and what to check between visits.</p>
            </div>
