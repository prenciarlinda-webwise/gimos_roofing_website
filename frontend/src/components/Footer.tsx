...
const quickLinks = [
  { name: "About Us", href: "/about", title: "About Gimo's Roofing" },
  ...
  { name: "Free Estimate", href: "/contact", title: "Get a Free Roofing Estimate" },
]
      ...
      <footer className="bg-secondary text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            {/* Company Info */}
            <div>
              <Link href="/" title="Gimo's Roofing - Jacksonville FL Roofing Company" className="inline-block mb-6">
                <Image
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com/gimosroofing" target="_blank" rel="noopener noreferrer" title="Gimo's Roofing on Facebook" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-secondary transition-all" aria-label="Facebook">
                ...
                <a href="https://www.instagram.com/gimosroofing/" target="_blank" rel="noopener noreferrer" title="Gimo's Roofing on Instagram" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-secondary transition-all" aria-label="Instagram">
                ...
                <a href="https://www.yelp.com/biz/gimos-renovation-and-roofing-jacksonville" target="_blank" rel="noopener noreferrer" title="Gimo's Roofing on Yelp" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-secondary transition-all" aria-label="Yelp">
                ...
                <a href="https://www.linkedin.com/company/gimo-s-renovation-roofing/" target="_blank" rel="noopener noreferrer" title="Gimo's Roofing on LinkedIn" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-secondary transition-all" aria-label="LinkedIn">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                <a href="https://www.youtube.com/channel/UC-Vq8SO3cVfOnWExWnt3K0w" target="_blank" rel="noopener noreferrer" title="Gimo's Roofing on YouTube" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary hover:text-secondary transition-all" aria-label="YouTube">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a2.994 2.994 0 0 0-2.107-2.117C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.391.524A2.994 2.994 0 0 0 .502 6.186 31.35 31.35 0 0 0 0 12a31.35 31.35 0 0 0 .502 5.814 2.994 2.994 0 0 0 2.107 2.117c1.886.524 9.391.524 9.391.524s7.505 0 9.391-.524a2.994 2.994 0 0 0 2.107-2.117A31.35 31.35 0 0 0 24 12a31.35 31.35 0 0 0-.502-5.814zM9.75 15.568V8.432L15.818 12 9.75 15.568z"/></svg>
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="tel:+19046065313" id="cta-footer-call" title="Call Gimo's Roofing Jacksonville" className="flex items-start gap-3 text-gray-300 hover:text-primary transition-colors">
                ...
                <li>
                  <a href="mailto:management@gimosroofing.com" id="cta-footer-email" title="Email Gimo's Roofing" className="flex items-start gap-3 text-gray-300 hover:text-primary transition-colors">
                    <svg className="w-5 h-5 mt-0.5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span>33 24th St E<br />Jacksonville, FL 32206</span>
                </li>
                <li className="flex items-start gap-3 text-gray-300">
                  <svg className="w-5 h-5 mt-0.5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-wrap gap-2">
              {serviceAreas.map((area) => (
                <Link
                  ...
                  title={`Roofing Services in ${area}, FL`}
          ...
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-6 text-sm">
                ...
                <Link href="/terms-of-service" title="Gimo's Roofing Terms of Service" className="text-gray-400 hover:text-primary transition-colors">Terms of Service</Link>
                <Link href="/sitemap" title="Gimo's Roofing Sitemap" className="text-gray-400 hover:text-primary transition-colors">Sitemap</Link>
              </div>
            </div>
