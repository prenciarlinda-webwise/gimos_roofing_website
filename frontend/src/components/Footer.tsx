          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a href="mailto:management@gimosroofing.com" title="Email Gimo's Roofing" className="flex items-start gap-3 text-gray-300 hover:text-primary transition-colors">
                    <svg className="w-5 h-5 mt-0.5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
