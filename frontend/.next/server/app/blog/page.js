(()=>{var e={};e.id=404,e.ids=[404],e.modules={2934:e=>{"use strict";e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},7812:(e,t,o)=>{"use strict";o.r(t),o.d(t,{GlobalError:()=>i.a,__next_app__:()=>h,originalPathname:()=>g,pages:()=>d,routeModule:()=>m,tree:()=>c}),o(7791),o(6330),o(5866);var s=o(3191),a=o(8716),r=o(7922),i=o.n(r),n=o(5231),l={};for(let e in n)0>["default","tree","pages","GlobalError","originalPathname","__next_app__","routeModule"].indexOf(e)&&(l[e]=()=>n[e]);o.d(t,l);let c=["",{children:["blog",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(o.bind(o,7791)),"C:\\Users\\arlin\\Desktop\\gimos_roofing_website\\frontend\\src\\app\\blog\\page.tsx"]}]},{}]},{layout:[()=>Promise.resolve().then(o.bind(o,6330)),"C:\\Users\\arlin\\Desktop\\gimos_roofing_website\\frontend\\src\\app\\layout.tsx"],"not-found":[()=>Promise.resolve().then(o.t.bind(o,5866,23)),"next/dist/client/components/not-found-error"]}],d=["C:\\Users\\arlin\\Desktop\\gimos_roofing_website\\frontend\\src\\app\\blog\\page.tsx"],g="/blog/page",h={require:o,loadChunk:()=>Promise.resolve()},m=new s.AppPageRouteModule({definition:{kind:a.x.APP_PAGE,page:"/blog/page",pathname:"/blog",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:c}})},8027:(e,t,o)=>{Promise.resolve().then(o.bind(o,2912))},2912:(e,t,o)=>{"use strict";o.r(t),o.d(t,{default:()=>d});var s=o(326),a=o(7577),r=o(434),i=o(6226);let n=[{slug:"how-to-check-florida-roofing-license",title:"How to Tell If a Florida Roofer Is Actually Legal (Before You Give Them a Dime)",metaTitle:"Checking Florida Roofing Licenses: A Jacksonville Homeowner's Guide",excerpt:"Don't get stuck with a bad roof or a lawsuit. Here's exactly how to check a Florida roofing contractor's license and insurance in under 5 minutes.",content:`<p class="text-lg text-gray-700 mb-6">Every year after hurricane season, Jacksonville neighborhoods get flooded with trucks from out of state. Some of these contractors are legitimate. Many are not.</p>
...
<p class="text-gray-600 mb-6">Want to discuss adding natural light to your home? Call (904) 606-5313 for a free consultation. We'll help you choose the right skylight type, assess your roof structure, and provide a complete quote with no surprises.</p>`,image:"/images/modern-home-new-shingle-roof.webp",category:"Homeowner Tips",date:"2025-01-03",readTime:"12 min read",author:"Gimo's Roofing Team",faqs:[{question:"How much does skylight installation cost in Jacksonville?",answer:"Fixed skylights run $800-1,800 total installed. Vented/operable skylights cost $1,200-3,000. Tubular skylights (sun tunnels) are $800-1,500. Costs include unit, flashing kit, and professional installation."},{question:"Do skylights cause roof leaks?",answer:"Poorly installed skylights are a leading cause of roof leaks. However, properly installed skylights with quality flashing kits rarely leak. The key is hiring a roofer experienced with skylight installation, not a general handyman."},{question:"What is the best type of skylight for Florida?",answer:"For Florida, choose skylights with impact-resistant glazing (required in many areas), low-E glass to reduce heat gain, and UV protection. VELUX and other quality brands offer Florida-specific models designed for our climate."},{question:"Can I add a skylight to an existing roof?",answer:"Yes, skylights can be added to most existing roofs. The process involves cutting through roofing, sheathing, and possibly modifying framing. It's best done during a roof replacement but can be a standalone project."}]}],l=["All","Roofing Guide","Homeowner Tips","Storm & Insurance"],c={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Home",item:"https://gimosroofing.com"},{"@type":"ListItem",position:2,name:"Blog",item:"https://gimosroofing.com/blog"}]};function d(){let[e,t]=(0,a.useState)("All"),o=[...n].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),d="All"===e?o:o.filter(t=>t.category===e);return(0,s.jsxs)(s.Fragment,{children:[s.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(c)}}),s.jsx("section",{className:"bg-gradient-to-br from-secondary to-secondary/90 text-white py-16",children:s.jsx("div",{className:"max-w-7xl mx-auto px-4",children:(0,s.jsxs)("div",{className:"text-center max-w-3xl mx-auto",children:[s.jsx("h1",{className:"text-3xl md:text-4xl font-bold mb-4",children:"Roofing Tips & Guides"}),s.jsx("p",{className:"text-lg text-gray-200",children:"Expert advice to help you protect your home and make informed decisions about your roof."})]})})}),s.jsx("section",{className:"py-6 bg-gray-50 border-b",children:s.jsx("div",{className:"max-w-7xl mx-auto px-4",children:s.jsx("div",{className:"flex flex-wrap justify-center gap-2",children:l.map(o=>s.jsx("button",{onClick:()=>t(o),className:`px-4 py-2 rounded-full text-sm font-medium transition-colors ${e===o?"bg-primary text-secondary":"bg-white text-gray-600 hover:bg-primary/10 hover:text-primary"}`,children:o},o))})})}),s.jsx("section",{className:"py-16",children:s.jsx("div",{className:"max-w-7xl mx-auto px-4",children:d.length>0?s.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-8",children:d.map(e=>s.jsx("article",{className:"bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow group",children:(0,s.jsxs)(r.default,{href:`/blog/${e.slug}`,className:"block",children:[s.jsx("div",{className:"aspect-video overflow-hidden relative",children:s.jsx(i.default,{src:e.image,alt:e.title,fill:!0,className:"object-cover group-hover:scale-105 transition-transform duration-300"})}),(0,s.jsxs)("div",{className:"p-6",children:[(0,s.jsxs)("div",{className:"flex items-center gap-3 mb-3",children:[s.jsx("span",{className:"px-3 py-1 bg-primary/10 text-primary text-xs font-semibold rounded-full",children:e.category}),s.jsx("span",{className:"text-gray-400 text-xs",children:e.readTime})]}),s.jsx("h2",{className:"text-lg font-bold text-secondary mb-2 group-hover:text-primary transition-colors",children:e.title}),s.jsx("p",{className:"text-gray-600 text-sm mb-4 line-clamp-2",children:e.excerpt}),(0,s.jsxs)("div",{className:"flex items-center justify-between",children:[s.jsx("time",{className:"text-gray-400 text-xs",dateTime:e.date,children:new Date(e.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}),(0,s.jsxs)("span",{className:"text-primary font-semibold text-sm flex items-center gap-1 group-hover:gap-2 transition-all",children:["Read More",s.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:s.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M9 5l7 7-7 7"})})]})]})]})]})},e.slug))}):s.jsx("div",{className:"text-center py-16",children:s.jsx("p",{className:"text-gray-500",children:"No posts found in this category."})})})}),s.jsx("section",{className:"py-16 bg-primary",children:(0,s.jsxs)("div",{className:"max-w-4xl mx-auto px-4 text-center",children:[s.jsx("h2",{className:"text-2xl md:text-3xl font-bold text-secondary mb-3",children:"Have Questions About Your Roof?"}),s.jsx("p",{className:"text-secondary/80 mb-6",children:"Get a free, no-obligation estimate and expert advice from our team."}),(0,s.jsxs)("div",{className:"flex flex-wrap justify-center gap-4",children:[s.jsx("a",{href:"https://app.roofr.com/instant-estimator/4db598a1-7ca9-4594-a916-031741fecbfc/GimosRoofing",target:"_blank",rel:"noopener noreferrer",className:"btn bg-secondary text-white hover:bg-secondary/90",children:"Get Your Free Estimate"}),s.jsx("a",{href:"tel:+19046065313",className:"btn bg-white text-secondary hover:bg-gray-100",children:"Call (904) 606-5313"})]})]})})]})}},7791:(e,t,o)=>{"use strict";o.r(t),o.d(t,{default:()=>s});let s=(0,o(8570).createProxy)(String.raw`C:\Users\arlin\Desktop\gimos_roofing_website\frontend\src\app\blog\page.tsx#default`)}};var t=require("../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),s=t.X(0,[854,326],()=>o(7812));module.exports=s})();